...
Band = 2; %integer from 1 to half of GaussWin radius (if don't want
...
for Frame = 1:NFrames
    imwrite(uint8(FrameArray(:,:,Frame)),...
        [FileNameBase '_' num2str(Frame) 'sameAmp__band' num2str(Band) '.png'],'png');
end
